    ...
    <div className="w-full max-w-2xl mx-auto text-center ">
      ...
      <form
        ...
        <input
          ...
          className="w-full border border-white sm:flex-1 px-6 py-4 rounded-full
           text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-4
            focus:ring-indigo-400/100 transition-all text-base"
        />
